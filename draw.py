...
############ CONSTANTS ############
pause = 0.01         # pause in each drawing step
time_limit = 100    # program drawing time limit
start_x = 800       
start_y = 350       
max_width = 300      # [px] max drawing canvas size
bezier_parts = 3    # 1 part bezier is an ordinary line
num_of_L_reduce = 1 # number of lines 'L' in svg to reduce to a single one 
